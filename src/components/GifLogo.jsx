export const GifLogo = () => {
  return (
    <div className="container-icon">
      <a itemProp="url" href="/" className="LogoContainer-sc-1osxem8 kUhCfT">
        <h4 className="Container-sc-gisexe ">
          <span className="LogoSpan-sc-1plmj4n cvtdQS">
